...
$approve = get_input('approve');
	...
	$form .= elgg_view('input/text', array('internalname' => 'rtags', 'id' => 'extendafriend_rtags', 'value' => "")) . "<br>";
	$form .= elgg_view('input/hidden', array('internalname' => 'friend_guid', 'value' => $friend->guid));
	...
	$friendcollections = extendafriend_get_friend_collections($friend->guid);
	...
	$form .= elgg_view('input/hidden', array('internalname' => 'approve', 'value' => $approve));
